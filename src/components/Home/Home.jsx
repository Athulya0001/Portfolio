...
const Home = () => {
  ...
  return (
    <div
      className={`w-full mx-auto pt-20 pb-10 px-6 md:flex md:items-center md:justify-between ${
    ...
    >
      <div className="md:w-1/2 space-y-8">
        ...
        <p className={`${darkMode ? "text-gray-300" : "text-gray-600"} text-justify leading-relaxed`}>
