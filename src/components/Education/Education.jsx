...
const Education = () => {
  ...
  return (
    <div className={`p-4 text-center ${darkMode ? "text-gray-100" : "text-gray-900"}`} id="education">
      <div className="py-4">
        <span
      ...
      <div className="flex justify-center">
        <div className="w-full md:w-4/5 lg:w-1/2">
          {educationData.map((edu, index) => (
            <motion.div
              key={index}
              className={`mt-4 p-4 shadow-md rounded-lg border-l-4 relative ${darkMode ? "bg-gray-900 border-pink-400" : "bg-gray-100 border-pink-500"}`}
